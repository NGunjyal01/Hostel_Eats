    ...
    return (
        <div className="bg-gradient-to-r from-black to-[#222831] min-h-screen text-white">
            <div className="flex flex-col items-center text-center p-4">
                <h1 className="pt-[10%] text-4xl font-bold underline">About Us</h1>
                <p className="pt-[2%] text-3xl">Welcome to <span className="text-red-500 font-bold">Hostel Eats</span>!</p>
                <p className="pt-[2%] text-2xl max-w-3xl text-gray-300">
                ...
                <h1 className="pt-[10%] text-4xl font-bold underline">Our Mission</h1>
                <p className="pt-[2%] text-2xl max-w-3xl text-gray-300">
                ...
                <ul className="pt-[2%] text-2xl max-w-3xl list-disc list-inside text-gray-300">
