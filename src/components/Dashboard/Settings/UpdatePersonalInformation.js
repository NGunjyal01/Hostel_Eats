...
const UpdatePersonalInformation = () => {
    ...
    return (
        <form onSubmit={handleSubmit(handleOnSubmit)} className="bg-[#222831] w-[85%] lg:w-[70%] h-fit ml-[8%] lg:ml-[15%] px-4 md:px-5 lg:px-10 py-4 sm:py-5 md:py-7 lg:py-10 mt-10 rounded-md sm:rounded-lg md:rounded-xl relative">
