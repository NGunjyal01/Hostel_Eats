...
const { searchItem, addItemToCart, getItemFromCart, removeItemFromCart, searchItemByCanteen, resetCartItem, getOrderDetails ,addFavouriteItem} = require("../controllers/customer");
